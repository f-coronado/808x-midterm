...
int main() {
  ...
  Eigen::Matrix<double, 1, 7> q_joint;
  q_joint << 0, 0, 3.14/2, 0, 3.14, 0, 1;
  ...
  Eigen::Matrix4d T_6n = transform.get_transform(q_joint(0,6), -transform.d7, 0, 0);
  ...
  Eigen::Matrix <double, 4, 1> x_p;
  x_p << T_0n(0, 3), T_0n(1, 3), T_0n(2, 3), T_0n(3, 3);
  std::cout << "x_p:\n" << x_p << std::endl;
